//Script to create random data to test functionality run with "bun run db:seed"
...
const SEED_USER_ID = 'user_2hfC4dQNFOoqVA8DnvS7OlFgpYo'
const SEED_CATEGORIES = [
  ...
  { id: 'category_7', name: 'Shop', userId: SEED_USER_ID, plaidId: null },
]
...
const generateRandomAmount = (category: typeof categories.$inferInsert) => {
  switch (category.name) {
    ...
    default:
      return Math.random() * 50 + 10 // Valor por defecto para otras categorías
  }
}
